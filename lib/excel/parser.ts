...
type Structure = { headerRow: number; columns: Record<string, number | undefined>; bands: Record<Band, { throughput?: number; prb?: number; traffic?: number; availability?: number; ta?: number }> };
